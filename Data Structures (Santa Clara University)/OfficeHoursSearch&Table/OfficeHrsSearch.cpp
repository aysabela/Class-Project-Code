...
void officeHoursSearch(vector<Student> studentVector) {
    int choice;
    string name;
    string topic;

    cout << "Choose 1 to search by a name or 2 to search by topic: ";
    cin >> choice;
    ...
    if (choice == 1) {
        ...
        for (int i = 0; i < studentVector.size(); i++) {
            if (studentVector.at(i).name == name) {
                cout << studentVector.at(i).name << " " << studentVector.at(i).subject << " Office Hour " << studentVector.at(i).office_hour << " attended" << endl;
            }
        }

    }
    else if (choice == 2) {
        cout << "Please enter the student subject: ";
        cin >> topic;


        for (int i = 0; i < studentVector.size(); i++) {

            if (studentVector.at(i).subject == topic) {
                cout << studentVector.at(i).subject << " " << studentVector.at(i).name << " Office Hour " << studentVector.at(i).office_hour <<  " attended" << endl;
            }
        }
...
int main() {
    ...
    for (int i = 0; i < 100; i++) {
        ...
        while (!students.empty()) {
            ...
            studentVector.push_back(nextStudent1);
    ...
    officeHoursSearch(studentVector);
    return 0;
}