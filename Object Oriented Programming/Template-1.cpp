/* Part 4 Questions
1. We put the entire template class in the .h file because class templates need both the declaration and definition for the compiler to compile the template. However,
if we were to separate them, we need to reinclude template in the cpp file and put template <typename T> (or class) above the functions
...
value you would want out of the quotient. This could be a problem if you actually want a proper quotient.
